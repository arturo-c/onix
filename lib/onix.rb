...
module ONIX
  class Formatters
    ...
    YYYYMMDDThhmmz = ->(value, *context) { value.strftime("%Y%m%dT%H%MZ") if value.respond_to? :strftime}
  ...
  autoload :Imprint, "onix/models/imprint"
  ...
  autoload :Publisher, "onix/models/publisher"
  ...
  autoload :PublishingDetail, "onix/models/publishing_detail"
  ...
  autoload :Price, "onix/models/price"
